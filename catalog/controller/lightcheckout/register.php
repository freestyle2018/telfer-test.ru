...
class ControllerLightcheckoutRegister extends Controller {
	public function index() {
		...
		$language_get = array('text_your_details','entry_customer_group','entry_firstname','entry_lastname','entry_telephone','entry_email','text_your_password','entry_password','entry_confirm','entry_company','entry_address_1','entry_address_2','entry_city','entry_postcode','entry_country','entry_zone','text_none','text_select');
