      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-article" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-image" data-toggle="tab">Галерея</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-affiliate_id"><?php echo $entry_affiliate_id; ?></label>
                <div class="col-sm-10">
                    <select id="input-affiliate_id" name="affiliate_id" class="form-control">
                    <option value="1" selected="selected"><?php echo $text_none; ?></option>
                    <?php foreach($affiliates as $affiliate) { ?>
                    <?php if($affiliate['affiliate_id'] == $affiliate_id) { ?>
                    <option value="<?php echo $affiliate['affiliate_id']; ?>" selected="selected"><?php echo $affiliate['firstname']; ?> <?php echo $affiliate['lastname']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $affiliate['affiliate_id']; ?>"><?php echo $affiliate['firstname']; ?> <?php echo $affiliate['lastname']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                  <!--<input type="text" name="affiliate_id" value="<?php echo $affiliate_id; ?>" placeholder="<?php echo $entry_affiliate_id; ?>" id="input-affiliate_id" class="form-control" />-->
                </div>
              </div>
