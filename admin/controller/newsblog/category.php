...
class ControllerNewsBlogCategory extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$settings_array['template_article']=$this->request->post['template_article'];
			$settings_array['template_category']=$this->request->post['template_category'];
			$settings_array['show_comments_vk_id']=$this->request->post['show_comments_vk_id'];
			$settings_array['show_comments_vk_category']=(isset($this->request->post['show_comments_vk_category']) ? (int)$this->request->post['show_comments_vk_category'] : 0);
			$settings_array['show_comments_vk_article']=(isset($this->request->post['show_comments_vk_article']) ? (int)$this->request->post['show_comments_vk_article'] : 0);
			$settings_array['show_comments_fb_category']=(isset($this->request->post['show_comments_fb_category']) ? (int)$this->request->post['show_comments_fb_category'] : 0);
			$settings_array['show_comments_fb_article']=(isset($this->request->post['show_comments_fb_article']) ? (int)$this->request->post['show_comments_fb_article'] : 0);
			$settings_array['show_comments_dq_id']=$this->request->post['show_comments_dq_id'];
			$settings_array['show_comments_dq_category']=(isset($this->request->post['show_comments_dq_category']) ? (int)$this->request->post['show_comments_dq_category'] : 0);
			$settings_array['show_comments_dq_article']=(isset($this->request->post['show_comments_dq_article']) ? (int)$this->request->post['show_comments_dq_article'] : 0);
			$settings=serialize($settings_array);
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['entry_comments_vk'] = $this->language->get('entry_comments_vk');
		$data['entry_comments_fb'] = $this->language->get('entry_comments_fb');
		$data['entry_comments_dq'] = $this->language->get('entry_comments_dq');
		$data['entry_show_comments_category'] = $this->language->get('entry_show_comments_category');
		$data['entry_show_comments_article'] = $this->language->get('entry_show_comments_article');
		...
		$data['help_comments_id'] = $this->language->get('help_comments_id');
		$data['help_comments_vk'] = $this->language->get('help_comments_vk');
		$data['help_comments_fb'] = $this->language->get('help_comments_fb');
		$data['help_comments_id_dq'] = $this->language->get('help_comments_id_dq');
		$data['help_comments_dq'] = $this->language->get('help_comments_dq');
		...
		if (isset($this->request->post['show_comments_vk_id'])) {
			$data['show_comments_vk_id'] = $this->request->post['show_comments_vk_id'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_vk_id'])) {
			$data['show_comments_vk_id'] = $category_info['show_comments_vk_id'];
		} else {
			$data['show_comments_vk_id'] = "";
		}

		if (isset($this->request->post['show_comments_vk_category'])) {
			$data['show_comments_vk_category'] = $this->request->post['show_comments_vk_category'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_vk_category'])) {
			$data['show_comments_vk_category'] = $category_info['show_comments_vk_category'];
		} else {
			$data['show_comments_vk_category'] = 0;
		}

		if (isset($this->request->post['show_comments_vk_article'])) {
			$data['show_comments_vk_article'] = $this->request->post['show_comments_vk_article'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_vk_article'])) {
			$data['show_comments_vk_article'] = $category_info['show_comments_vk_article'];
		} else {
			$data['show_comments_vk_article'] = 0;
		}

		if (isset($this->request->post['show_comments_fb_category'])) {
			$data['show_comments_fb_category'] = $this->request->post['show_comments_fb_category'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_fb_category'])) {
			$data['show_comments_fb_category'] = $category_info['show_comments_fb_category'];
		} else {
			$data['show_comments_fb_category'] = 0;
		}

		if (isset($this->request->post['show_comments_fb_article'])) {
			$data['show_comments_fb_article'] = $this->request->post['show_comments_fb_article'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_fb_article'])) {
			$data['show_comments_fb_article'] = $category_info['show_comments_fb_article'];
		} else {
			$data['show_comments_fb_article'] = 0;
		}

		if (isset($this->request->post['show_comments_dq_id'])) {
			$data['show_comments_dq_id'] = $this->request->post['show_comments_dq_id'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_dq_id'])) {
			$data['show_comments_dq_id'] = $category_info['show_comments_dq_id'];
		} else {
			$data['show_comments_dq_id'] = "";
		}

		if (isset($this->request->post['show_comments_dq_category'])) {
			$data['show_comments_dq_category'] = $this->request->post['show_comments_dq_category'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_dq_category'])) {
			$data['show_comments_dq_category'] = $category_info['show_comments_dq_category'];
		} else {
			$data['show_comments_dq_category'] = 0;
		}

		if (isset($this->request->post['show_comments_dq_article'])) {
			$data['show_comments_dq_article'] = $this->request->post['show_comments_dq_article'];
		} elseif (!empty($category_info) && isset($category_info['show_comments_dq_article'])) {
			$data['show_comments_dq_article'] = $category_info['show_comments_dq_article'];
		} else {
			$data['show_comments_dq_article'] = 0;
		}
